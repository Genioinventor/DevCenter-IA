...
const AVISO_TITULO = "¡Bienvenido a DevCenter!"; // <--- Título del aviso
...
const AVISO_VECES_MOSTRADAS = 3; // <--- Cuántas veces se mostrará el aviso al usuario (0 = infinitas veces)
// ===========================================================================
